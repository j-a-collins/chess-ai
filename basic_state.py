...
"""
Main module for chess board state
...
class State(object):
    ...
    def serialise(self):
        """Function to validate the state of the board."""
        # TODO: some handling for user making two moves in succession and breaking the game
        ...
        # # # Final column indicates white or black's turn
        binary_state[4] = self.board.turn * 1.0
        return binary_state

    def edges(self):
        """Returns a dynamic list of legal moves as a list."""
