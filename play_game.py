...
class Valuator(object):
  ...
  def __init__(self):
    ...
    vals = torch.load("neural_nets/value.pth", map_location=lambda storage, loc: storage)
    self.model = Net()
...
def explore_leaves(s, v):
  ...
  spinner = Halo(text='A.I. IS SEARCHING MIND-STATE',text_color='cyan', spinner='simpleDotsScrolling',color='cyan')
  spinner.start()
  start = time.time()
  v.reset()
  bval = v(s)
